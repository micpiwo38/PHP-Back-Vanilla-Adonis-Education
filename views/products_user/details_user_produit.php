                ...
                <div class="container mx-auto">
                    <div class="card h-100">
                            ...
                            <div class="carousel-inner mx-auto text-center">
                                <?php foreach ($product['images'] as $index => $image): ?>
                                    <div class="mx-auto carousel-item <?= $index === 0 ? 'active' : '' ?>">
                                        <img width="25%" class="mx-auto img-fluid" src="./src/images/<?= ($image["images_name"]) ?>" alt="<?= $product["product_name"] ?>" title="<?= $product["product_name"] ?>">
                                    </div>
                                <?php endforeach; ?>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <a href="supprimer-produits?id=<?php echo $product["product_id"] ?>" class="btn btn-danger">Supprimer</a>
